      ...
      <div className='grid grid-cols-2'>
        ...
        </div>
        {
          showImage && <div className=' flex flex-col justify-center items-center'>
            <img src={require('./assets/images/Capture.JPG')} alt = {'logo'} className=' h-80 w-80 object-cover object-center ' />
            <button onClick={handleDownload} className="text-white bg-buttonColor hover:bg-gradient-to-br focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Download</button>
          </div>
        }
      </div>
